SHARED_ARGS="--features 64 128 128 2048 --replay_buffer_capacity 200_000 --batch_size 32 --min_update_horizon 3 --max_update_horizon 10 \
    ...
    --gamma_horizon_decay_steps 10_000 --reset_frequency 20_000 --eval"
